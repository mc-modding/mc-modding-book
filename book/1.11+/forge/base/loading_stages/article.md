...
Учитывая 3 основные стадии загрузки Forge мода, наш главный файл мода должен выглядить приблизительно так:
...
Если вы запустите клиент с этим кодом загрзуки стадий, то в консоли увидите следующее:
